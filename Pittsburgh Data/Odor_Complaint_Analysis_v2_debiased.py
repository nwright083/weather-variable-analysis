...
def custom_show():
    global plot_counter
    plot_counter += 1
    filename = f"Pittsburgh Data/odor_plot_{plot_counter}_debiased.png"
    plt.savefig(filename, dpi=300, bbox_inches='tight')
    print(f"Saved plot to {filename}")
    
    # Copy to artifact directory
    artifact_path = os.path.join("/Users/nawrig04/.gemini/antigravity-ide/brain/c18d086a-2ac0-4770-8b4a-94a15887ba69", f"pittsburgh_odor_plot_{plot_counter}_debiased.png")
    try:
...
plt.savefig("Pittsburgh Data/odor_plot_poisson_marginal_debiased.png", dpi=300, bbox_inches='tight')
plt.close()
plt.show = custom_show
