...
def custom_show():
    global plot_counter
    plot_counter += 1
    filename = f"Louisville Data/odor_plot_{plot_counter}.png"
    plt.savefig(filename, dpi=300, bbox_inches='tight')
    print(f"Saved plot to {filename}")
    
    # Copy to artifact directory
    artifact_path = os.path.join("/Users/nawrig04/.gemini/antigravity-ide/brain/4662ad4d-69b2-4f27-8219-50d0fe7ac91c", f"louisville_odor_plot_{plot_counter}.png")
    try:
...
html_path = 'louisville_odor_map.html'
...
static_path = 'louisville_static_choropleth.png'
